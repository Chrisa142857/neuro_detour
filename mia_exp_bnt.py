...
batch_size = 5000
device = 'cuda:2'
saver = 'baseline_BNT-grouped_out'
...
class GraphNet(nn.Module):
    def __init__(self, in_channel, out_channel, hid_channel=768, **kwargs) -> None:
        ...
        self.net = MODEL_BANK['bnt'](node_sz=self.node_sz, in_channel=in_channel, out_channel=hid_channel, hidden_size=hid_channel, nlayer=2)
