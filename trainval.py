...
def main():
    ...
    parser.add_argument('--lconsist_w', type=float, default = 1)
    ...
    for i in range(args.cv_fold_n):
        ...
        model = MODEL_BANK[args.models](node_sz=node_sz, out_channel=hiddim, in_channel=input_dim, batch_size=args.batch_size, device=device, nlayer=args.nlayer, heads=args.nhead, lconsist_w=args.lconsist_w).to(device)
