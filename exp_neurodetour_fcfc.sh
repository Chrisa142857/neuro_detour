...
dt=$(date '+%d-%m-%Y-%H-%M-%S');
python trainval.py --models neurodetour --classifier gcn --dataname hcpa --bold_winsize 100 --device cuda:2 --node_attr FC --atlas Gordon_333 > logs/neurodetour2H1L_gcn_hcpa_dynfcFC_gordon_${dt}.log
dt=$(date '+%d-%m-%Y-%H-%M-%S');
...
dt=$(date '+%d-%m-%Y-%H-%M-%S');
python trainval.py --models neurodetour --classifier gcn --dataname ukb --bold_winsize 500 --device cuda:2 --node_attr FC --atlas Gordon_333 > logs/neurodetour2H1L_gcn_ukb_statfcFC_gordon_${dt}.log
dt=$(date '+%d-%m-%Y-%H-%M-%S');
python trainval.py --models neurodetour --classifier gcn --dataname ukb --bold_winsize 100 --device cuda:2 --node_attr FC --atlas Gordon_333 > logs/neurodetour2H1L_gcn_ukb_dynfcFC_gordon_${dt}.log
dt=$(date '+%d-%m-%Y-%H-%M-%S');
