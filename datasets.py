...
if __name__ == '__main__':
    ...
    tl, vl, ds = dataloader_generator(dname=dname, atlas_name='D_160', node_attr='FC', fc_winsize=500)#, transform=NAGdataTransform(), transform=NeuroDetourNode(k=5, node_num=333)
    # d = []
    y = []
    x = []
    for data in tqdm(ds):
